	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_industry_professor"><i class="fa fa-plus"></i> Add New Industry Professor</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT *,concat(firstname,' ',lastname) as name FROM industry_professor_list order by concat(firstname,' ',lastname) asc");
					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      ...
		                      <a class="dropdown-item" href="./index.php?page=edit_industry_professor&id=<?php echo $row['id'] ?>">Edit</a>
		                      <div class="dropdown-divider"></div>
