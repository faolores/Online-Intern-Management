...
<div class="col-lg-12">
	<div class="callout callout-info">
		<div class="d-flex w-100 justify-content-center align-items-center">
			<label for="faculty">Select Intern</label>
	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<div>
			<h3 class="text-center">Evaluation Form</h3>
			<hr>
			<table width="100%">
					<tr>
						<td width="50%"><p><b>Intern: <span id="fname"></span></b></p></td>
						<td width="50%"><p><b>Academic Year: <span id="ay"><?php echo $_SESSION['academic']['year'].' '.(ordinal_suffix($_SESSION['academic']['semester'])) ?> Trimester</span></b></p></td>
					</tr>
					<tr>
						<td width="50%"><p><b>Company: <span id="classField"></span></b></p></td>
...
<script>
	...
	function getHeadGrade() {
		let head_grade_input = $("#head_grade_input").val();

		let IndustryProfessorGrade = (sum_grand_per * .7).toFixed(2);
		let headGrade = (head_grade_input * .3).toFixed(2);
		$("#comp_per_grade").val(IndustryProfessorGrade);
		$("#head_grade").val(headGrade);
		let final_grade = (Number(IndustryProfessorGrade) + Number(headGrade)).toFixed(2);
		final_grade = Number(final_grade);
		$("#final_grade").val(final_grade);
		let apc_final_grade = 0;
		if (final_grade >= 95 && final_grade <= 100) {
			apc_final_grade = "4.00"
		} else if (final_grade >= 91 && final_grade <= 94.99) {
			apc_final_grade = "3.50"
		} else if (final_grade >= 87 && final_grade <= 90.99) {
			apc_final_grade = "3.00"
		} else if (final_grade >= 83 && final_grade <= 86.99) {
			apc_final_grade = "2.50"
		} else if (final_grade >= 79 && final_grade <= 82.99) {
			apc_final_grade = "2.00"
		} else if (final_grade >= 75 && final_grade <= 78.99) {
			apc_final_grade = "1.50"
		} else if (final_grade >= 70 && final_grade <= 74.99) {
			apc_final_grade = "1.00"
		} else if (final_grade <= 69.99) {
			apc_final_grade = "R"
		} else {
			apc_final_grade = "0.00"
		}

		$("#final_rating").val(apc_final_grade);
	}
</script>