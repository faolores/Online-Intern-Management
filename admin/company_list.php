...
<script>
	$(document).ready(function(){
		...
		$('.new_class').click(function(){
			uni_modal("New Company","<?php echo $_SESSION['login_view_folder'] ?>manage_class.php")
		})
		$('.manage_class').click(function(){
			uni_modal("Manage Company","<?php echo $_SESSION['login_view_folder'] ?>manage_class.php?id="+$(this).attr('data-id'))
		})
	$('.delete_class').click(function(){
	_conf("Are you sure to delete this Company?","delete_class",[$(this).attr('data-id')])
	})
	})
