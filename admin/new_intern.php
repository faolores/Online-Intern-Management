		...
		<div class="card-body">
			<form action="" id="manage_faculty">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						<div class="form-group">
							...
							<input type="text" name="school_id" pattern="[0-9]{4}-[0-9]{6}" class="form-control form-control-sm" placeholder = "2022-100191" required value="<?php echo isset($school_id) ? $school_id : '' ?>">
						</div>
						<div class="form-group">
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button" onclick="location.href = 'index.php?page=intern_list'">Cancel</button>
				</div>
			</form>
		</div>
	</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
						location.replace('index.php?page=intern_list')
					},750)
				}else if(resp == 2){
