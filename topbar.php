...
<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-dark navbar-yellow">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
            ...
            <a class="nav-link"  data-toggle="dropdown" aria-expanded="true" href="javascript:void(0)">
              <span>
                <div class="d-felx badge-pill">
                  ...
                  <span><b style="color:black"><?php echo ucwords($_SESSION['login_firstname']) ?></b></span>
                  <span class="fa fa-angle-down ml-2" style="color:black"></span>
                </div>
